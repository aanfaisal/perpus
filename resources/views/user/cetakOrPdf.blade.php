...
<div class="page-header">
    <h1 align="center">Pilihan Cetak</h1>
        </div>
            <div class="row">
                <div class="col-sm-4">
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <div class="col-sm-9">
                <a href="{{ asset('anggota/cari_cetak') }}"><button class="btn btn-lg btn-primary  bg-blue glyphicon glyphicon-print "> Cetak</button></a></div>
                <a href="{{ asset('anggota/cari_pdf') }}"><button class="btn btn-lg btn-primary  bg-blue glyphicon glyphicon-save-file "> PDF</button></a>                   
