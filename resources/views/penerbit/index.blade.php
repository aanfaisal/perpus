...
@section('main')
 ...
 <div class="panel panel-primary ">
    <div class="panel-heading">
        <h3 class="panel-title">Penerbit</h3>
    </div>
        <div class="panel-body">
        <!-- /.box-header -->
            <table id="tPenerbit" class="table table-bordered table-striped table-hover">
                <thead>
                    <tr>                                                         
                        <th>Nama</th>
                        <th>Telepon</th>
            ...
            <script src="{{asset('assets/app/penerbit.js')}}"></script>
        @endpush                        

{{-- {{ link_to('penerbit/tambah',' Tambah',['class'=>'btn btn-xs bg-blue glyphicon glyphicon-plus']) }} --}}

<div class="pull-left">
        <button id="btn_add" name="btn_add" class="btn btn-xs bg-blue glyphicon glyphicon-plus pull-right"> Tambah</button>
    </div>&nbsp;

{{ link_to('penerbit/semua_pdf',' Cetak',['class'=>'btn btn-xs bg-blue glyphicon glyphicon-print','target'=>'_blank']) }}


{{-- MODAL TAMBAH/EDIT SECTION --}}
        <div class="modal fade" id="ModPenerbit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                        <h4 class="modal-title" id="myModalLabel">Data Penerbit</h4>
                    </div>
                ...
                <form id="frmPenerbit">
                    ...
                    {{-- id --}}
                    <input type="hidden" name="id_penerbit" id="id_penerbit" value="0">
                    
                    {{-- nama penerbit --}}
                    <div class="form-group" >
                        <label class="control-label">Nama</label>
                        <input class="form-control" type="text" name="nm_penerbit" id="nm_penerbit" placeholder="nama penerbit">  
