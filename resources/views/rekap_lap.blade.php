...
<br> 
<center>Tanggal : {{$tgl11}} s/d {{$tgl22}}</center> 
<br>
  ...
  <tr>
    ...
    <td class="tg-yw4l">{{$anggota_jkl}}</td>
  </tr>
  <tr>
    <td class="tg-9hbo"></td>
    <td class="tg-yw4l"></td>
    ...
    <td class="tg-yw4l">{{$anggota_jkp}}</td>
  </tr>
  <tr>
    <td class="tg-9hbo"></td>
    <td class="tg-yw4l"></td>
...
<!-- this row will not appear when printing -->
      <div class="row no-print">
        <div class="col-xs-12">
          <a href="{{asset('rekap_lap_cetak')}}" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
          {{-- <a href="invoice-print.html" target="_blank" class="btn btn-success "><i class="fa fa-file-pdf-o"></i> Generate PDF</a> --}}
        </div>
      </div>
                        </div>
                    </div>
