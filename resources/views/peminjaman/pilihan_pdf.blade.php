	...
	<h1 align="center">Cetak/Download</h1>
		...
		<div class="row">
			<div class="col-sm-4">
				...
				{!! Form::open(['url' => 'peminjaman/dwn_pdfPeminjaman', 'method'=>'GET']) !!}
				...
				{!! Form::text('tgl1', date('Y-m-d'), array('class' => 'form-control pull-right','id' => 'datepicker1')) !!}
				@if($errors->has('tgl1'))
			...
			<div class="form-group">
				<label>s/d </label>  					
					<div class="input-group date">
						...
						{!! Form::text('tgl2', date('Y-m-d'), array('class' => 'form-control pull-right','id' => 'datepicker2')) !!}
						@if($errors->has('tgl2'))
...
{!! Form::close() !!}
	...
	<div class="col-md-6">
		<br>
		{!! Form::open(['url' => 'peminjaman/semua_pdfPeminjaman', 'method'=>'GET']) !!}
