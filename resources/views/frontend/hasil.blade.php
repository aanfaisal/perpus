            ...
            <div class="col s12">
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <input type="text" class="typeahead" name="q1" data-role="materialtags" autocomplete="off">
                        ...
                        <button type="submit" class="btn btn-flat pink accent-3 waves-effect waves-light white-text right cari">Cari <i class="material-icons right">search</i></button>
                            ...
                            <a href="{{asset('/')}}" class="btn btn-flat pink accent-3 waves-effect waves-light white-text right">refresh <i class="material-icons right">refresh</i></a>
                </div>
            </div>
    </form> --}}
    {{-- end pencarian --}}

<a href="{{asset('/')}}" class="btn btn-flat pink accent-3 waves-effect waves-light white-text right">kembali <i class="material-icons right">refresh</i></a>
    {{-- Page container --}}
